export default {
  ...
  skills: {
    ...
    descriptions: [
      '能够准确还原视觉稿，熟悉响应式设计',
      '熟悉 JavaScript 常用语法，项目开发使用 TypeScript 提高代码的可靠性和可维护性',
      '熟悉 React、Vue 技术栈和相关生态，包括路由、状态管理库和各类工具库',
      '熟悉主流组件库使用和二次封装，包括 Ant Design、Ant Design Mobile 等',
      '熟悉前后端交互，例如 Axios 使用及二次封装，了解 fetch、AJAX 和 Node.js 等',
      '了解前端工程化，包括 Vite、Webpack、Rollup、Babel 等',
      '熟悉 Git 工作流和包管理器常用命令',
      '具备代码质量意识，包括采用规范、重构、Code Review 等方式进行优化',
      '具备自学能力，并使用 Copilot、ChatGPT 等 AI 工具辅助开发，提高效率',
  ...
  experiences: [
    {
      type: 'company',
      icon: '/eleme.svg',
      company: '法本信息技术股份有限公司（阿里外包）',
      position: '前端工程师',
      time: '2023 年 08 月 - 2024 年 03 月',
      descriptions: [
        '负责饿了么放心点·榜、VIP、拼团、小饿替你点等导购业务迭代开发',
        '参与需求评审，回复相关技术问题，评估工时确定排期，产出前端系分文档',
        '针对业务所使用的集团内部框架和库，汇总并反馈相关 bug，提供相关 case 复现 demo',
        '根据系统监控和业务反馈，及时排查并修复问题',
      ],
    },
    {
      type: 'company',
      ...
      descriptions: [
        ...
        '参与需求评审，提出合理建议与解决方案，评估工时确定排期',
        '参与搭建业务组件库，持续优化产品交互体验',
        '基于 Node-Red 并结合业务场景，模拟牛舍内网关和各类传感器硬件，提高测试效率',
      ],
    },
    {
      type: 'education',
      ...
      descriptions: ['专业排名 23 / 103，曾获数学建模省奖、校级奖学金等'],
    },
  ],
  projects: [
    {
    ...
    },
    {
      ...
      stack: ['uni-app', 'Vue 2', 'uView', 'WebSocket', 'MQTT'],
      details: [
